...
namespace GameCaro
{
    public class ChessBoardManager
    {
        ...
        public ChessBoardManager(Panel chessBoard, TextBox playerName, PictureBox mark)
        {
            ...
            {
                new Player("1", Image.FromFile(Application.StartupPath + "\\Resources\\icons8-x-100.png")),
                new Player("2", Image.FromFile(Application.StartupPath + "\\Resources\\icons8-circle-96.png"))
            };
        ...
        public bool Undo()
        {
            ...
            CurrentPlayer = lastMove.CurrentPlayer == 1 ? 0 : 1;
            ChangePlayer();
            return true;
        }
