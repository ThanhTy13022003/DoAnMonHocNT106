...
namespace DoAnMonHocNT106
{
    public partial class Form_Introduce : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string title = "Cảm ơn";
            string message = "Cảm ơn các bạn đã đóng góp ý kiến quý báu của mình cho chúng tôi! \n" +
                             "Và mọi sự đóng góp của các bạn xin gửi về mail admin@example.com của chúng tôi.";
